...
function OurStore(props) {
  ...
  return (
    <div>
      ...
      <Hoc class1="store-wrapper home-wrapper-2 py-5">
        <div className="row">
          <div className="col-3">
              ...
              <div>
                ...
                <div className="form-check">
                  <input
                    ...
                    id=""
                  />
                  <p className="form-check-lable">In Stock (1)</p>
                </div>
                <div className="form-check">
                  <input
                    type="checkbox"
                    ...
                    id=""
                  />
                  <p className="form-check-lable">Out Of Stock (1)</p>
                </div>
              ...
              <div>
                <div className="form-check">
                  <input
                    ...
                    id="color"
                  />
                  <p className="form-check-lable">M (1)</p>
                </div>
                <div className="form-check">
                  <input
                    type="checkbox"
                    ...
                    id="color-1"
                  />
                  <p className="form-check-lable">XL (1)</p>
                </div>
              </div>
            </div>
              ...
              <div className="d-flex justify-content-between align-items-center gap-10">
                <div className="d-flex align-items-center gap-10">
                  ...
                  <select name="" className="form-control form-select" id="">
                    ...
                    <option value="created-ascending">Date, high to low</option>
