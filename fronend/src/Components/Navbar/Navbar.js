...
function Navbar(props) {
  return (
    <>
      <nav className="header-top-strip py-3">
          ...
          <div className="row">
            ...
            <div className="col-6">
              <p className="text-end text-white mb-0">
                Hotline:
                <a className="text-white" href="tel:+91 9444052343">
                  +91 9444052343
                </a>
              </p>
            </div>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-5">
              <div className="input-group">
                ...
                />
                <span className="input-group-text p-3" id="button-addon2">
                  <BsSearch className="fs-6 pink" />
                </span>
              </div>
            </div>
            <div className="col-5">
